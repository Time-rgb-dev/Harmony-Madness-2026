	...
	draw_text((global.window_width / 2) - 128, (global.window_height/2) + 64+10, "OPTIONS MENU");
	shader_reset();
	
	//Draw character select
	if(zone_sel == zone_arr+1) palette_swap(tex_pal_textselect1, 1);
	draw_text((global.window_width / 2) - 128, (global.window_height/2) + 64+24, "CHARACTER: ");
	draw_set_halign(fa_right);
	draw_text((global.window_width / 2) + 128, (global.window_height/2) + 64+24, string(char_list[char_sel][0]));
	draw_set_halign(fa_left);
	shader_reset();