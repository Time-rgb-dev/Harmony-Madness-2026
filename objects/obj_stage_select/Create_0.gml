	...
	quotes = ["WELCOME TO HARMONY MADNESS!", "WHAT THE FUCK", "I WANNA FUCK LANGEEEEE", "IM CRINE", "WELCOME TO HELL!", "THIS WAS A MISTAKE", "FROSTY WAS HERE", "EMPTY STRING", "NULL", "VOID", "TS SO PEAK", "KILL YOURSELF!!!!!", "HOP ON ELEMENTS", "DARK IS A BIG FAT FUCKING CHUD", "LLOYD WAS HERE"];
