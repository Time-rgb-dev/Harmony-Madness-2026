/// @description Draw the HUD
	...
	if (!instance_exists(obj_bonus_level)) {
		...
		if(global.stage_timer >= 540000 && FRAME_TIMER mod 20 < 20/2) draw_sprite(spr_hudtext, 4, 16 + offset[1], 24);
		...
		//Attention keeper
		if (global.subway_surfers && room != rm_scary_green_hill) draw_sprite(spr_subway_surfers, image_index, WINDOW_WIDTH - 84, WINDOW_HEIGHT / 2);
